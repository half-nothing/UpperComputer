...
class UDPServer(Sockets):
    def __init__(self, net_type: Sockets.IPProtocol, local_host: Optional[str] = None, local_port: int = 8888,
                 read_buffer: int = 1024, read_handler=None, broadcast: bool = False) -> None:
        ...
        self._logger.info(f"UDPServerInit, listen: {self.local_address}")

    def broadcast(self, data: Union[str, bytes], port: Optional[int] = None, encoding: Optional[str] = None) -> bool:
